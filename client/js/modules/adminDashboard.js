 ...
 */
      ...
      $scope.lookupUsers_group = {};
       ...
       $scope.loadMoreDiscusstions = function(){
            $http({
                method: 'GET',
                url: '/api/discussions',
                params: {numOfDiscussions: $scope.numOfDiscussionsSelection.value}
            }).then(function(res){
                $scope.discussions = res.data.discs;
	...
	$scope.downloadAllCsv = function(){
            ...
            $http({
                ...
                var blob = new Blob([content], {'type':"application/zip;base64"});
                a.href = URL.createObjectURL(blob);
                a.download = "Hot Discusstion Zip.zip";
                a.click();
